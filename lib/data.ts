...
export async function fetchProjects(hackathonId: string): Promise<Project[]> {
  ...
  return [
    ...
    },
    {
      id: "6",
      name: "FoodShare",
      description: "Platform connecting restaurants with excess food to local shelters and food banks to reduce waste.",
...
export async function fetchProjectDetail(hackathonId: string, projectId: string): Promise<ProjectDetail> {
  // Simulate API call delay
  ...
  const projects: Record<string, ProjectDetail> = {
    ...
    "2": {
      ...
      techStack: ["Next.js", "Firebase", "TailwindCSS", "WebRTC", "Stripe"],
    ...
    "4": {
      ...
      techStack: ["React Native", "GraphQL", "PostgreSQL", "Apollo", "D3.js"],
    ...
    "6": {
      ...
      techStack: ["React", "Express", "MongoDB", "Node.js", "Google Maps API"],
