    ...
    <div className="min-h-screen bg-[#0a0a16] text-white">
      ...
      <div className="relative z-10 container mx-auto py-8 px-4">
        <div className="flex items-center mb-8">
          <Button variant="ghost" size="sm" asChild className="text-indigo-200 hover:text-white hover:bg-indigo-500/10">
            <Link href={`/hackathons/${params.id}`} className="flex items-center gap-1">
        ...
        <Suspense fallback={<ProjectDetailLoading />}>
          <ProjectDetail hackathonId={params.id} projectId={params.projectId} />
        </Suspense>
      </div>
    </div>
  )
